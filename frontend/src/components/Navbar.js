...
const Navbar = () => {
  ...
  const navLinks = [
    ...
    { path: "/wattu", label: "Wattu - Opinions & Réflexions" },
    { 
      label: t('events'),
      dropdown: [
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
              ...
              {navLinks.map((link, index) => (
                link.dropdown ? (
                  ...
                  >
                    ...
                    <div 
                      className="absolute top-full left-0 w-56 z-50 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200"
                    >
            ...
            <button
              ...
              className="lg:hidden p-2 rounded-lg hover:bg-[#E0F2E0] transition-colors"
              data-testid="mobile-menu-button"
              aria-label="Toggle menu"
            >
              {isOpen ? (
                <X className="h-6 w-6 text-[#006B47]" />
              ) : (
                <Menu className="h-6 w-6 text-[#006B47]" />
              )}
            </button>
          </div>
        </div>
