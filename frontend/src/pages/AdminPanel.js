...
import { Settings, Quote, Calendar, Users, RefreshCw, LogOut, Archive, Book, MessageSquare, Layout, Video } from "lucide-react";
...
const AdminPanel = () => {
  ...
  const fetchData = async () => {
    setLoading(true);
    try {
      const [quotesRes, eventsRes, newsletterRes, contactRes, videosRes, khalifesRes, archivesStatsRes, wattuStatsRes, dynamicPagesStatsRes] = await Promise.all([
